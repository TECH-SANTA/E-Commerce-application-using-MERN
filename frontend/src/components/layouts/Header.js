...
export default function Header() {
    ...
    const { items: cartItems } = useSelector(state => state.cartState) || { items: [] };
        ...
        <nav className="navbar row">
            <div className="col-12 col-md-3">
                <div className="navbar-brand">
                    <Link to="/">
                        <img width="150px" alt='D-cart Logo' src="/images/D-CART.png" />
                    </Link>
                </div>
            </div>
                ...
                {isAuthenticated && user ? (
                    <Dropdown className='d-inline'>
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item onClick={() => navigate('/')} className='text-dark'>Home</Dropdown.Item>
